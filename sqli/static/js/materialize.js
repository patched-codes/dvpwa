  ...
  return function (e, t, r, a) {
    function n(e) {
        ...
        var p = r[u].element;if (t || o.loop || ("none" === o.display && S.setPropertyValue(p, "display", o.display), "hidden" === o.visibility && S.setPropertyValue(p, "visibility", o.visibility)), o.loop !== !0 && (f.queue(p)[1] === a || !/\.velocityQueueEntryFlag/i.test(f.queue(p)[1])) && i(p)) {
          i(p).isAnimating = !1, i(p).rootPropertyValueCache = {};var d = !1;f.each(S.Lists.transforms3D, function (e, t) {
            var r = /^scale/.test(t) ? 1 : 0,
                n = i(p).transformCache[t];i(p).transformCache[t] !== a && /^\([a-zA-Z][^.]/.test(n) && (d = !0, delete i(p).transformCache[t]);
      ...
      b.Easings[t[0]] = l.apply(null, t[1]);
          ...
          function safeRemoveClass(e, t) {
              if (e.classList) {
                  e.classList.remove(t);
              } else {
                  const tParts = t.split(' ');
                  const safeRegex = new RE2('(^|\\s)' + tParts.join('|') + '(\\s|$)', 'gi');
                  e.className = e.className.toString().replace(safeRegex, ' ');
              }
          }
        ...
        function e(e) {
          function p(e, t) {
            ...
            var E;i(o).tweensContainer && i(o).isAnimating === !0 && (E = i(o).tweensContainer), f.each(y, function (e, t) {
              if (RegExp("^(red|green|blue|yellow|orange|purple|black|white)$").test(e)) {
                var r = p(t, !0),
                    n = r[0],
                    o = r[1],
