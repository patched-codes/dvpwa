...
async def csrf_processor(request):
    """Generates a CSRF token and provides a function to access it.
    
    Args:
        request (Request): The incoming request object.
    
    Returns:
        dict: A dictionary containing a 'csrf_token' function that generates or returns an existing CSRF token.
