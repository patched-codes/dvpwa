...
def authorize(ensure_admin=False):
    """Decorator function to authorize requests and optionally ensure admin privileges.
...
async def get_auth_user(request: Request) -> Optional[User]:
    """Retrieves the authenticated user based on the session information in the request.
